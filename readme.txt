...
Pastikan sudah memiliki compiler python terbaru dan aplikasi jena fuseki.

1. Buat dataset pada jena fuseki dengan nama "data_bukuu"
2. Kemudian import file dataset.rdf pada data_bukuu
3. Masuk ke folder api kemudian run command "pip install flask" dan "pip install flask-cors"
